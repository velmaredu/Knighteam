...
public class ResultadosDruida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_druida);
        ...
        textoResultadosDruida = findViewById(R.id.resultados);
    ...
    protected void onStart() {
        ...
        firebaseDatabase.getReference().child("Diario").child(String.valueOf(sesion.getNumLobby())).child("Druida").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        enemigoReference.child(String.valueOf(getNumRonda() + 1)).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                firebaseDatabase.getReference().child("Diario").child(String.valueOf(sesion.getNumLobby())).child("Druida").child("ResultadosAcumulados").setValue(resultadosAcumulados);
            }
